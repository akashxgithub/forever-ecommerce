    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-700">
          <p>
            ...
            sint placeat fugit mollitia. Ullam, illo?
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam
            esse modi molestiae vero iure, eum suscipit cum harum est hic?
          </p>
      ...
      <div className="flex flex-col md:flex-row textsm mb-20">
        ...
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          ...
          <p className="text-gray-600">Our team dedicated professionals is to here to assist you the way, ensuring your satisfication is our top priority</p>
        </div>
      </div>
      <NewsletterBox/>
    </div>
